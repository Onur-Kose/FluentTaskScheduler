namespace FluentTaskScheduler.Core
{
    public interface IScheduledJobRegistry
    {
        ...
        /// <summary>
        /// Returns a task that completes when the job list or a registered definition changes.
        ...
        /// and subscribe to TimedJobConfig.Changed for live edits. Honor cancellation to
        /// release abandoned waits. Subscribe before GetJobs()
